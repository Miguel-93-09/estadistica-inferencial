...
alpha=0.05
abline(v=-qnorm(1-alpha),lty=2,col="red")
text(-qnorm(1-alpha),0.02,expression(z[alpha]==-z[1-alpha]),pos=4, col="red")
...
{\frac1{`r n1-1`}\left(\frac{`r s1`^2}{`r n1`}\right)^2+\frac1{`r n2-1`}\left(\frac{`r s2`^2}{`r n2`}\right)^2}
=`r round((s1^2/n1+s2^2/n2)^2/((1/(n1-1))*(s1^2/n1)^2+(1/(n2-1))*(s2^2/n2)^2),2)`.
$$
...
El **$p$-valor** del contraste será: 
$P(t_{`r (s1^2/n1+s2^2/n2)^2/((1/(n1-1))*(s1^2/n1)^2+(1/(n2-1))*(s2^2/n2)^2)`}\leq 
`r round((media1-media2)/sqrt(s1^2/n1+s2^2/n2),3)`)=
`r round(pt((media1-media2)/sqrt(s1^2/n1+s2^2/n2),(s1^2/n1+s2^2/n2)^2/((1/(n1-1))*(s1^2/n1)^2+(1/(n2-1))*(s2^2/n2)^2)),3)`,$ valor muy pequeño.
